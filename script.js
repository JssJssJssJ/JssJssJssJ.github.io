...
result4.textContent = `Arvin ikä vuosina: ${years} vuo${years !== 1 ? 'tta' : 'si'}<br> Arvin ikä kuukausina: ${months} kuukau${months !== 1 ? 'tta' : 'si'}<br> Arvin ikä viikkoina: ${weeks} viikko${weeks !== 1 ? 'a' : ''}<br> Arvin ikä päivinä: ${daysDifference4} päiv${daysDifference4 !== 1 ? 'ää' : 'ä'}`;
